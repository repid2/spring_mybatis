	...
	<div class="container" >
		<div class="reg_frm_box">
			<form method="post" action="/member/regUpdate.do" role="form" class="form-horizontal">
				...
				<div class="form-group reg_total">
					<label for="userNick" class="col-sm-3 control-label">닉네임 (*)</label>
					<div class="reg_input col-sm-9">
				...
				<div class="form-group reg_total">
					<label for="userPhone"  class="col-sm-3 control-label">전화번호 (*), '-' 입력 제외 </label> 
					<div class="reg_input col-sm-9">
				...
				<div class="form-group reg_total">
					<label for="GenderLabel" class="col-sm-3 control-label">성별 (*)</label> 
					<div class="reg_input col-sm-9">
				...
				<div class="form-group reg_total">
					<label class="col-sm-3 control-label" id="regEmaillabel" >생년월일 (*)</label>
					<div class="reg_input col-sm-9">
